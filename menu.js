      ...
      bootStrap.hookCreatedSettingsMenu(function(pageSettings) {
        ...
        pageSettings.settingsMenu.hookAfterAddingFixedMenuItems(function(menu, menuItems) {
          ...
          var airportsItem = new VRS.MenuItem({
            ...
            labelKey: function() { return 'Aiports'; },
              ...
              if (showAirports) {
                var myMapType = new google.maps.ImageMapType({
                  getTileUrl: function(coord, zoom) {
                    return "http://1.tile.maps.openaip.net/geowebcache/service/tms/1.0.0/openaip_basemap@EPSG%3A900913@png/" + zoom + "/" + coord.x + "/" + (Math.pow(2, zoom) - coord.y - 1) + ".png";
                  },
